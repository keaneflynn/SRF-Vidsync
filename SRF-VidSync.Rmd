...
Mean_Total_Volume_Dataset <- Fish_Dataset %>% 
  ...
  mutate(total_volume_sample = sum(volume_occupied_all_cm3))
...
Total_Volume_Plot <- 
  ...
  stat_summary(aes(x = site, y = total_volume_sample, fill = sample_event, width = 0.5), geom = "bar", fun.y = mean, position = "dodge") +
  stat_summary(aes(x = site, y = avg_volume_subsample, fill = sample_event, width = 0.5), geom = "errorbar", fun.data = mean_se, position = "dodge") +
  theme_bw() +
